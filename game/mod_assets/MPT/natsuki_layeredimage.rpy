...
layeredimage natsuki turned:
    ...
    # at natsuki_filter_instance
    at SpriteWrapper(name="natsuki")

    group zordermouth multiple:
        attribute am null 
        attribute az null 

    group autofocus multiple:
        attribute afz null
        attribute aff null
    ...
    group left: #Left arm.
        ...
        attribute ldown default if_any(["dress"]):
            "mod_assets/MPT/natsuki/natsuki_turned_dress_left_down.png"
        ...
        attribute lhip if_any(["dress"]):
            "mod_assets/MPT/natsuki/natsuki_turned_dress_left_hip.png"
        ...
        attribute lpoint if_any(["dress"]):
            "mod_assets/MPT/natsuki/natsuki_turned_dress_left_point.png"
    ...
    group right: #right half of her body.
        ...
        attribute rdown default if_any(["dress"]):
            "mod_assets/MPT/natsuki/natsuki_turned_dress_right_down.png"
        ...
        attribute rhip if_any(["dress"]):
            "mod_assets/MPT/natsuki/natsuki_turned_dress_right_hip.png"
    ...
    group jewellery if_all(["ff"]) if_not(["fta","fs"]):
        attribute brooch default if_any(["dress"]):
            "mod_assets/MPT/natsuki/natsuki_ff_brooch.png"
...
####################The "sad, turned away" face, and the few expressions it has.
    ...
    group jewellery if_all(["fs"]):
        attribute brooch default if_any(["dress"]):
            "mod_assets/MPT/natsuki/natsuki_fs_brooch.png"
...
layeredimage natsuki cross:
    ...
    always:
        "mod_assets/MPT/natsuki/natsuki_crossed(ff)_dress.png" if_all(["dress","ff"])
    always:
        "mod_assets/MPT/natsuki/natsuki_crossed(fs)_dress.png" if_all(["dress"]) if_any(["fs","fta"])
    always:
