layeredimage yuri turned:
    ...
    # at yuri_filter_instance
    at SpriteWrapper(name="yuri")
    ...
    group left:
        ...
        xoffset (0.5)
        #dress
        attribute ldown default if_all(["dress"]) if_any(["rdown"]):
            "mod_assets/MPT/yuri/yuri_turned_dress_left_down_right_down.png"

        attribute ldown default if_all(["dress"]) if_any(["rup"]):
            "mod_assets/MPT/yuri/yuri_turned_dress_left_down_right_up.png"

        attribute lup if_all(["dress"]) if_any(["rdown"]):
            "mod_assets/MPT/yuri/yuri_turned_dress_left_up_right_down.png"

        attribute lup if_all(["dress"]) if_any(["rup"]):
            "mod_assets/MPT/yuri/yuri_turned_dress_left_up_right_up.png"
    ...
    group right:
        ...
        subpixel (True)
        yoffset (-0.5)
        attribute rdown default if_any(["dress"]) null
        attribute rup if_any(["dress"]) null
    ...
    group jewellery:
        ...
        attribute earring default if_any(["dress"]):
            "mod_assets/MPT/yuri/yuri_turned_dress_earring.png"
...
layeredimage yuri shy:
    ...
    group outfit:
        ...
        attribute dress default:
            "mod_assets/MPT/yuri/yuri_shy_dress_bodybase.png"
        attribute uniform:
    ...
    group jewellery:
        ...
        attribute earring default if_any(["dress"]):
            "mod_assets/MPT/yuri/yuri_shy_dress_earring.png"